// Auto-generated. Per-entity form-enhancements config for "Produktionsplanung".
...
export const formEnhancements: FormEnhancements = {
  ...
  defaults: {
    'geplantes_druckdatum': { kind: 'today' },
    'druckstatus': { kind: 'lookup', key: 'geplant', label: 'Geplant' },
  },
  computed: {},
};
