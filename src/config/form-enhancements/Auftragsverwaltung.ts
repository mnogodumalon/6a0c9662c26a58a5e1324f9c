...
export const formEnhancements: FormEnhancements = {
  fieldOrder: [
    ...
    'kunde',
    'motive',
    { row: ['breite_cm', 'hoehe_cm'], cols: '1fr 1fr' },
    'anzahl',
    'material_auswahl',
    'montage_gewuenscht',
    'lieferadresse_abweichend',
    'wunschlieferdatum',
    { row: ['lieferstrasse', 'lieferhausnummer'], cols: '2fr 1fr' },
    { row: ['lieferpostleitzahl', 'lieferort'], cols: '1fr 2fr' },
    'sonderwuensche',
    'interne_notizen',
  ],
  defaults: {
    ...
    'wunschlieferdatum': { kind: 'todayOffset', days: 14 },
