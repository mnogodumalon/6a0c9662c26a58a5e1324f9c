    ...
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            <Label className="text-xs text-muted-foreground">Unternehmen / Firma</Label>
            <p className="text-sm">{record.fields.unternehmen ?? '—'}</p>
          </div>
          <div className="space-y-1">
            <Label className="text-xs text-muted-foreground">Kundentyp</Label>
            <Badge variant="secondary">{record.fields.kundentyp?.label ?? '—'}</Badge>
          </div>
          <div className="space-y-1">
          ...
          <div className="space-y-1">
            <Label className="text-xs text-muted-foreground">Anmerkungen zum Kunden</Label>
